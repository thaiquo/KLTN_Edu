...
contract DeployEduConnectEscrowV2 is Script {
    ...
    function run() external returns (EduConnectEscrowV2 escrow) {
        ...
        if (block.chainid == ANVIL_CHAIN_ID) {
            ...
            escrow = new EduConnectEscrowV2(tokenAddress, platformWallet, adminWallet);
            vm.stopBroadcast();
        ...
        console2.log("EduConnectEscrowV2", address(escrow));
