import{C as e,D as t,E as n,M as r,b as i,j as a,l as o,r as s,s as c,t as l,v as u,w as d,y as ee}from"./ModalController-DLyGHbfk.js";import{_ as f,c as p,d as m,f as te,l as h,m as g,o as _,p as ne,s as v,v as y,w as re,x as b,y as x}from"./wui-text-BTwUa-zK.js";import{t as ie}from"./SwapController-DikmMhig.js";import"./wui-icon-box-aoX7RuOP.js";import{t as S}from"./ConstantsUtil-C1qdKpER.js";import{_ as C,d as w,v as T}from"./index-BgJzc2pV.js";import{n as E}from"./exports-CIXOvUUo.js";var D={isUnsupportedChainView(){return i.state.view===`UnsupportedChain`||i.state.view===`SwitchNetwork`&&i.state.history.includes(`UnsupportedChain`)},async safeClose(){if(this.isUnsupportedChainView()){l.shake();return}if(await T.isSIWXCloseDisabled()){l.shake();return}(i.state.view===`DataCapture`||i.state.view===`DataCaptureOtpConfirm`)&&o.disconnect(),l.close()}},ae=f`
  :host {
    display: block;
