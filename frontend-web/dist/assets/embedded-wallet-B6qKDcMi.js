import{B as e,F as t,K as n,M as r,U as i,V as a,b as o,g as s,i as c,j as l,l as u,r as d,rt as f,t as p,v as m,w as h,y as g}from"./ModalController-DLyGHbfk.js";import{_,c as v,f as y,l as b,m as x,o as S,s as C,w,x as T,y as E}from"./wui-text-BTwUa-zK.js";import{n as D,t as O}from"./ref-BkVckqZm.js";import{g as k,j as ee,w as A}from"./index-_BidmnHu.js";var j=w`
  div {
    width: 100%;
  }
...
`,Z=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},Q=class extends E{constructor(){super(),this.formRef=O(),this.usubscribe=[],this.name=``,this.error=``,this.loading=A.state.loading,this.suggestions=A.state.suggestions,this.profileName=d.getAccountData()?.profileName,this.onDebouncedNameInputChange=a.debounce(e=>{e.length<4?this.error=`Name must be at least 4 characters long`:k.isValidReownName(e)?(this.error=``,A.getSuggestions(e)):this.error=`The value is not a valid username`}),this.usubscribe.push(A.subscribe(e=>{this.suggestions=e.suggestions,this.loading=e.loading}),d.subscribeChainProp(`accountState`,e=>{this.profileName=e?.profileName,e?.profileName&&(this.error=`You already own a name`)}))}firstUpdated(){this.formRef.value?.addEventListener(`keydown`,this.onEnterKey.bind(this))}disconnectedCallback(){super.disconnectedCallback(),this.usubscribe.forEach(e=>e()),this.formRef.value?.removeEventListener(`keydown`,this.onEnterKey.bind(this))}render(){return T`
    ...
    `}onNameInputChange(e){let t=k.validateReownName(e.detail||``);this.name=t,this.onDebouncedNameInputChange(t)}onKeyDown(e){e.key.length===1&&!k.isValidReownName(e.key)&&e.preventDefault()}templateSuggestions(){return!this.name||this.name.length<4||this.error?null:T`<wui-flex flexDirection="column" gap="1" alignItems="center">
