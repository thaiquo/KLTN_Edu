import{C as e,D as t,E as n,M as r,b as i,j as a,l as o,r as s,s as c,t as l,v as u,w as d,y as ee}from"./ModalController-DLyGHbfk.js";import{_ as f,c as p,d as m,f as te,l as h,m as g,o as _,p as ne,s as v,v as y,w as re,x as b,y as x}from"./wui-text-BTwUa-zK.js";import{t as ie}from"./SwapController-B46I5n_5.js";import"./wui-icon-box-aoX7RuOP.js";import{t as S}from"./ConstantsUtil-C1qdKpER.js";import{S as C,h as w,x as T}from"./index-et8CFuYY.js";import{n as E}from"./exports-CxVMJEE2.js";var D={isUnsupportedChainView(){return i.state.view===`UnsupportedChain`||i.state.view===`SwitchNetwork`&&i.state.history.includes(`UnsupportedChain`)},async safeClose(){if(this.isUnsupportedChainView()){l.shake();return}if(await C.isSIWXCloseDisabled()){l.shake();return}(i.state.view===`DataCapture`||i.state.view===`DataCaptureOtpConfirm`)&&o.disconnect(),l.close()}},ae=f`
  :host {
    display: block;
...
`,k=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},ce={info:`info`,success:`checkmark`,warning:`warningCircle`,error:`warning`},A=class extends x{constructor(){super(...arguments),this.message=``,this.type=`info`}render(){return b`
    ...
    `}onClose(){T.close()}};A.styles=[g,se],k([p()],A.prototype,`message`,void 0),k([p()],A.prototype,`type`,void 0),A=k([h(`wui-alertbar`)],A);var le=f`
  :host {
    display: block;
    position: absolute;
    top: ${({spacing:e})=>e[3]};
...
`,L=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},ge=[`SmartSessionList`],_e={PayWithExchange:y.tokens.theme.foregroundPrimary};function R(){let e=i.state.data?.connector?.name,t=i.state.data?.wallet?.name,n=i.state.data?.network?.name,r=t??e,a=u.getConnectors(),o=a.length===1&&a[0]?.id===`w3m-email`,c=s.getAccountData()?.socialProvider,l=c?c.charAt(0).toUpperCase()+c.slice(1):`Connect Social`;return{Connect:`Connect ${o?`Email`:``} Wallet`,Create:`Create Wallet`,ChooseAccountName:void 0,Account:void 0,AccountSettings:void 0,AllWallets:`All Wallets`,ApproveTransaction:`Approve Transaction`,BuyInProgress:`Buy`,UsageExceeded:`Usage Exceeded`,ConnectingExternal:r??`Connect Wallet`,ConnectingWalletConnect:r??`WalletConnect`,ConnectingWalletConnectBasic:`WalletConnect`,ConnectingSiwe:`Sign In`,Convert:`Convert`,ConvertSelectToken:`Select token`,ConvertPreview:`Preview Convert`,Downloads:r?`Get ${r}`:`Downloads`,EmailLogin:`Email Login`,EmailVerifyOtp:`Confirm Email`,EmailVerifyDevice:`Register Device`,GetWallet:`Get a Wallet`,Networks:`Choose Network`,OnRampProviders:`Choose Provider`,OnRampActivity:`Activity`,OnRampTokenSelect:`Select Token`,OnRampFiatSelect:`Select Currency`,Pay:`How you pay`,ProfileWallets:`Wallets`,SwitchNetwork:n??`Switch Network`,Transactions:`Activity`,UnsupportedChain:`Switch Network`,UpgradeEmailWallet:`Upgrade Your Wallet`,UpdateEmailWallet:`Edit Email`,UpdateEmailPrimaryOtp:`Confirm Current Email`,UpdateEmailSecondaryOtp:`Confirm New Email`,WhatIsABuy:`What is Buy?`,RegisterAccountName:`Choose Name`,RegisterAccountNameSuccess:``,WalletReceive:`Receive`,WalletCompatibleNetworks:`Compatible Networks`,Swap:`Swap`,SwapSelectToken:`Select Token`,SwapPreview:`Preview Swap`,WalletSend:`Send`,WalletSendPreview:`Review Send`,WalletSendSelectToken:`Select Token`,WalletSendConfirmed:`Confirmed`,WhatIsANetwork:`What is a network?`,WhatIsAWallet:`What is a Wallet?`,ConnectWallets:`Connect Wallet`,ConnectSocials:`All Socials`,ConnectingSocial:l,ConnectingMultiChain:`Select Chain`,ConnectingFarcaster:`Farcaster`,SwitchActiveChain:`Switch Chain`,SmartSessionCreated:void 0,SmartSessionList:`Smart Sessions`,SIWXSignMessage:`Sign In`,PayLoading:`Processing payment...`,PayQuote:`Payment Quote`,DataCapture:`Profile`,DataCaptureOtpConfirm:`Confirm Email`,FundWallet:`Fund Wallet`,PayWithExchange:`Deposit from Exchange`,PayWithExchangeSelectAsset:`Select Asset`,SmartAccountSettings:`Smart Account Settings`}}var z=class extends x{constructor(){super(),this.unsubscribe=[],this.heading=R()[i.state.view],this.network=s.state.activeCaipNetwork,this.networkImage=n.getNetworkImage(this.network),this.showBack=!1,this.prevHistoryLength=1,this.view=i.state.view,this.viewDirection=``,this.unsubscribe.push(t.subscribeNetworkImages(()=>{this.networkImage=n.getNetworkImage(this.network)}),i.subscribeKey(`view`,e=>{setTimeout(()=>{this.view=e,this.heading=R()[e]},S.ANIMATION_DURATIONS.HeaderText),this.onViewChange(),this.onHistoryChange()}),s.subscribeKey(`activeCaipNetwork`,e=>{this.network=e,this.networkImage=n.getNetworkImage(this.network)}))}disconnectCallback(){this.unsubscribe.forEach(e=>e())}render(){let e=_e[i.state.view]??y.tokens.theme.backgroundPrimary;return this.style.setProperty(`--local-header-background-color`,e),b`
    ...
    `}onWalletHelp(){d.sendEvent({type:`track`,event:`CLICK_WALLET_HELP`}),i.push(`WhatIsAWallet`)}async onClose(){await D.safeClose()}rightHeaderTemplate(){let e=r?.state?.features?.smartSessions;return i.state.view!==`Account`||!e?this.closeButtonTemplate():b`<wui-flex>
      <wui-icon-button
        icon="clock"
        size="lg"
        iconSize="lg"
    ...
    `}leftHeaderTemplate(){let{view:e}=i.state,t=e===`Connect`,n=r.state.enableEmbedded,a=e===`ApproveTransaction`,o=e===`ConnectingSiwe`,s=e===`Account`,c=r.state.enableNetworkSwitch,l=a||o||t&&n;return s&&c?b`<wui-select
        id="dynamic"
        data-testid="w3m-account-select-network"
        active-network=${_(this.network?.name)}
        @click=${this.onNetworks.bind(this)}
        imageSrc=${_(this.networkImage)}
      ></wui-select>`:this.showBack&&!l?b`<wui-icon-button
    ...
    ></wui-icon-button>`}onNetworks(){this.isAllowedNetworkSwitch()&&(d.sendEvent({type:`track`,event:`CLICK_NETWORKS`}),i.push(`Networks`))}isAllowedNetworkSwitch(){let e=s.getAllRequestedCaipNetworks(),t=e?e.length>1:!1,n=e?.find(({id:e})=>e===this.network?.id);return t||!n}onViewChange(){let{history:e}=i.state,t=S.VIEW_DIRECTION.Next;e.length<this.prevHistoryLength&&(t=S.VIEW_DIRECTION.Prev),this.prevHistoryLength=e.length,this.viewDirection=t}async onHistoryChange(){let{history:e}=i.state,t=this.shadowRoot?.querySelector(`#dynamic`);e.length>1&&!this.showBack&&t?(await t.animate([{opacity:1},{opacity:0}],{duration:200,fill:`forwards`,easing:`ease`}).finished,this.showBack=!0,t.animate([{opacity:0},{opacity:1}],{duration:200,fill:`forwards`,easing:`ease`})):e.length<=1&&this.showBack&&t&&(await t.animate([{opacity:1},{opacity:0}],{duration:200,fill:`forwards`,easing:`ease`}).finished,this.showBack=!1,t.animate([{opacity:0},{opacity:1}],{duration:200,fill:`forwards`,easing:`ease`}))}onGoBack(){i.goBack()}};z.styles=he,L([v()],z.prototype,`heading`,void 0),L([v()],z.prototype,`network`,void 0),L([v()],z.prototype,`networkImage`,void 0),L([v()],z.prototype,`showBack`,void 0),L([v()],z.prototype,`prevHistoryLength`,void 0),L([v()],z.prototype,`view`,void 0),L([v()],z.prototype,`viewDirection`,void 0),z=L([h(`w3m-header`)],z);var ve=f`
  :host {
    display: flex;
    align-items: center;
    gap: ${({spacing:e})=>e[1]};
...
`,H=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},U=class extends x{constructor(){super(),this.unsubscribe=[],this.timeout=void 0,this.open=a.state.open,this.unsubscribe.push(a.subscribeKey(`open`,e=>{this.open=e,this.onOpen()}))}disconnectedCallback(){clearTimeout(this.timeout),this.unsubscribe.forEach(e=>e())}render(){let{message:e,variant:t}=a.state;return b` <wui-snackbar message=${e} variant=${t}></wui-snackbar> `}onOpen(){clearTimeout(this.timeout),this.open?(this.animate([{opacity:0,transform:`translateX(-50%) scale(0.85)`},{opacity:1,transform:`translateX(-50%) scale(1)`}],{duration:150,fill:`forwards`,easing:`ease`}),this.timeout&&clearTimeout(this.timeout),a.state.autoClose&&(this.timeout=setTimeout(()=>a.hide(),2500))):this.animate([{opacity:1,transform:`translateX(-50%) scale(1)`},{opacity:0,transform:`translateX(-50%) scale(0.85)`}],{duration:150,fill:`forwards`,easing:`ease`})}};U.styles=ye,H([v()],U.prototype,`open`,void 0),U=H([h(`w3m-snackbar`)],U);var be=f`
  :host {
...
`,W=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},G=`scroll-lock`,xe={PayWithExchange:`0`,PayWithExchangeSelectAsset:`0`,Pay:`0`,PayQuote:`0`,PayLoading:`0`},K=class extends x{constructor(){super(),this.unsubscribe=[],this.abortController=void 0,this.hasPrefetched=!1,this.enableEmbedded=r.state.enableEmbedded,this.open=l.state.open,this.caipAddress=s.state.activeCaipAddress,this.caipNetwork=s.state.activeCaipNetwork,this.shake=l.state.shake,this.filterByNamespace=u.state.filterByNamespace,this.padding=y.spacing[1],this.mobileFullScreen=r.state.enableMobileFullScreen,this.initializeTheming(),e.prefetchAnalyticsConfig(),this.unsubscribe.push(l.subscribeKey(`open`,e=>e?this.onOpen():this.onClose()),l.subscribeKey(`shake`,e=>this.shake=e),s.subscribeKey(`activeCaipNetwork`,e=>this.onNewNetwork(e)),s.subscribeKey(`activeCaipAddress`,e=>this.onNewAddress(e)),r.subscribeKey(`enableEmbedded`,e=>this.enableEmbedded=e),u.subscribeKey(`filterByNamespace`,t=>{this.filterByNamespace!==t&&!s.getAccountData(t)?.caipAddress&&(e.fetchRecommendedWallets(),this.filterByNamespace=t)}),i.subscribeKey(`view`,()=>{this.dataset.border=w.hasFooter()?`true`:`false`,this.padding=xe[i.state.view]??y.spacing[1]}))}firstUpdated(){if(this.dataset.border=w.hasFooter()?`true`:`false`,this.mobileFullScreen&&this.setAttribute(`data-mobile-fullscreen`,`true`),this.caipAddress){if(this.enableEmbedded){l.close(),this.prefetch();return}this.onNewAddress(this.caipAddress)}this.open&&this.onOpen(),this.enableEmbedded&&this.prefetch()}disconnectedCallback(){this.unsubscribe.forEach(e=>e()),this.onRemoveKeyboardListener()}render(){return this.style.setProperty(`--local-modal-padding`,this.padding),this.enableEmbedded?b`${this.contentTemplate()}
