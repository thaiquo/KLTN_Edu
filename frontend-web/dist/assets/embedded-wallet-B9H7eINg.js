import{B as e,F as t,K as n,M as r,U as i,V as a,b as o,g as s,i as c,j as l,l as ee,r as u,rt as d,t as f,v as p,w as m,y as h}from"./ModalController-DLyGHbfk.js";import{_ as g,c as _,f as v,l as y,m as b,o as x,s as S,w as C,x as w,y as T}from"./wui-text-BTwUa-zK.js";import{n as E,t as D}from"./ref-BkVckqZm.js";import{A as O,C as k,h as A}from"./index-et8CFuYY.js";var j=C`
  div {
    width: 100%;
  }
...
`,Z=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},Q=class extends T{constructor(){super(),this.formRef=D(),this.usubscribe=[],this.name=``,this.error=``,this.loading=k.state.loading,this.suggestions=k.state.suggestions,this.profileName=u.getAccountData()?.profileName,this.onDebouncedNameInputChange=a.debounce(e=>{e.length<4?this.error=`Name must be at least 4 characters long`:A.isValidReownName(e)?(this.error=``,k.getSuggestions(e)):this.error=`The value is not a valid username`}),this.usubscribe.push(k.subscribe(e=>{this.suggestions=e.suggestions,this.loading=e.loading}),u.subscribeChainProp(`accountState`,e=>{this.profileName=e?.profileName,e?.profileName&&(this.error=`You already own a name`)}))}firstUpdated(){this.formRef.value?.addEventListener(`keydown`,this.onEnterKey.bind(this))}disconnectedCallback(){super.disconnectedCallback(),this.usubscribe.forEach(e=>e()),this.formRef.value?.removeEventListener(`keydown`,this.onEnterKey.bind(this))}render(){return w`
    ...
    `}onNameInputChange(e){let t=A.validateReownName(e.detail||``);this.name=t,this.onDebouncedNameInputChange(t)}onKeyDown(e){e.key.length===1&&!A.isValidReownName(e.key)&&e.preventDefault()}templateSuggestions(){return!this.name||this.name.length<4||this.error?null:w`<wui-flex flexDirection="column" gap="1" alignItems="center">
