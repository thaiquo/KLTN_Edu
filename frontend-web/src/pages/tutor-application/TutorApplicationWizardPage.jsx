...
import { ApiError, isConflict, isUnauthorized } from '../../api/client';
...
import { TutorApplicationStepper } from '../../components/tutor-application/TutorApplicationStepper';
import { WizardNavigation } from '../../components/tutor-application/WizardNavigation';
import { BasicInfoStep } from '../../components/tutor-application/steps/BasicInfoStep';
import { EducationExperienceStep } from '../../components/tutor-application/steps/EducationExperienceStep';
import { TeachingSubjectsStep } from '../../components/tutor-application/steps/TeachingSubjectsStep';
import { IntroductionStep } from '../../components/tutor-application/steps/IntroductionStep';
import { VerificationDocumentsStep } from '../../components/tutor-application/steps/VerificationDocumentsStep';
import { ReviewSubmitStep } from '../../components/tutor-application/steps/ReviewSubmitStep';
...
export function TutorApplicationWizardPage() {
            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
              <div>
                ...
                <p className="mt-3 max-w-2xl text-sm font-semibold leading-7 text-slate-300">
                  Xây dựng hồ sơ từng bước, rõ ràng và dễ quay lại chỉnh sửa. Backend application là nguồn dữ liệu chính.
                </p>
              </div>
              {application && (
  ...
  return (
    <section className="rounded-[8px] border border-slate-200 bg-white p-5">
      ...
      <p className="mt-2 text-sm font-semibold leading-6 text-slate-500">
        {approved
          ? 'FS4 chưa tạo link Tutor Profile mới để tránh route chưa có API chính thức.'
