export function AuthLayout({ title, description, children, wide = false }) {
  return (
    <main className="auth-shell">
      <section className="story">
        <a className="logo">E <b>EduConnect</b></a>
        <div>
          <small>HỌC ĐÚNG NGƯỜI · TIẾN BỘ ĐÚNG HƯỚNG</small>
