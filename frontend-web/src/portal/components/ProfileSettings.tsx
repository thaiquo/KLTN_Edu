...
import { Briefcase, KeyRound, Settings2 } from "lucide-react";
...
export function ProfileSettings({ activeRole }: ProfileSettingsProps) {
  ...
  return (
    <div className="font-sans max-w-7xl mx-auto pb-10 space-y-6">
      ...
      <div className="bg-transparent rounded-2xl">
        ...
        {activeTab === "teaching" && <TeachingRegistrationPage embedded={true} />}
        {activeTab === "password" && <ChangePasswordPage embedded={true} />}
        {activeTab === "tutor" && (
