...
public interface SubjectRepository extends JpaRepository<Subject, Long> {
    ...
    List<Subject> findByCategoryIdAndNameContainingIgnoreCaseAndActiveTrueOrderByNameAsc(
            Long categoryId,
            String keyword,
            Pageable pageable
    );

    List<Subject> findByGroupIdAndNameContainingIgnoreCaseAndActiveTrueOrderByNameAsc(
            Long groupId,
            String keyword,
            Pageable pageable
    );
