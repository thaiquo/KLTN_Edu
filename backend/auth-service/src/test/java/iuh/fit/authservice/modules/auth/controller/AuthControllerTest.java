package iuh.fit.authservice.modules.auth.controller;
...
import iuh.fit.authservice.modules.auth.service.AuthService;
...
class AuthControllerTest {
    ...
    void register_shouldReturnApiResponse() throws Exception {
        ...
        when(authService.register(any())).thenReturn(new AuthResponseBody(account, "Registered successfully. Please verify your email."));
    ...
    void login_shouldReturnApiResponse() throws Exception {
        ...
        when(authService.login(any(), any(), any(), any())).thenReturn(new AuthResponseBody(account, "Login successful"));
